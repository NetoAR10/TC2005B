...
const canAns = require('../util/can-answer');
const problemasController = require('../controllers/problemas.controller');

router.get('/problema1', isAuth, canAns, problemasController.get_problema1);
router.post('/problema1', isAuth, canAns, problemasController.post_problema1);
...
router.get('/:problema_id', isAuth, canView, problemasController.get_root);

router.get('/', isAuth, canView, problemasController.get_root);
